...
namespace DAL.App.EF.AppDataInit
{
    class EntityManager
    {
        ...
        {
            var suitableStartTime = new DateTime(startTime.Year, startTime.Month, startTime.Day);
            suitableStartTime = suitableStartTime.AddMinutes(startTime.Minute);
            suitableStartTime = suitableStartTime.AddHours(startTime.Hour);
            var lesson = new Lesson
            {
                Start = suitableStartTime,
                End = suitableStartTime.AddMinutes(minutes),
