...
namespace WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<SingletonDemo>();
            services.AddTransient<TransientDemo>();
            services.AddScoped<ScopedDemo>();

            services.AddTransient<IDiTransient, TransientDemo>();
            services.AddScoped<IDiScoped, ScopedDemo>();
            services.AddSingleton<IDiSingleton, SingletonDemo>();
